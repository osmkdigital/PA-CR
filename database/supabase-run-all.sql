-- =========================================================
-- Royal Flush — combined Supabase setup (run this ONE file,
-- top to bottom, in the SQL Editor). It's just
-- supabase-setup.sql followed by supabase-crm-update.sql,
-- so you don't have to worry about running two files in the
-- right order. Every statement is idempotent — safe to
-- re-run this whole thing any time.
-- =========================================================
